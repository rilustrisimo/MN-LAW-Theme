<?php
/**
 * * Main Class. Classes and functions for Eyor Theme.
 *
...
class Theme {
    ...
    // Register a custom taxonomy for portfolio items - Example: "Skills"
    public function register_portfolio_taxonomies() {
        ...
        $args = array(
            'hierarchical' => false, // Set to true if you want a hierarchical structure
            'labels' => $labels,
            'show_ui' => true,
            'show_admin_column' => true,
            'query_var' => true,
            'rewrite' => array('slug' => 'portfolio-category'), // Customize the slug
        );
            ...
            foreach( $a_post_types as $a_post_type ) {
                ...
                if( !empty( $a_post_type['post_type'] ) ) {
                    ...
                    $a_args = array(
                        ...
                        'taxonomies'            => $a_post_type['taxonomies']
                    );

...
<article id="<?php echo get_post_type() . '-' . $post_id; ?>" <?php post_class( $post_class ); ?> itemscope
	...
	<a href="<?php echo esc_url( $permalink ); ?>">
		...
		if ( $thumbnail ) {
			...
			printf( '<div class="qedgrid__item__image" %s></div><div class="clearfix"></div><div class="qedgrid__item__content"><h3 class="qedgrid__item__title">%s</h3><p class="qedgrid__item__description">%s</p><div class="qedgrid__item__meta"><time datetime="%s" itemprop="datePublished"><i class="fa-solid fa-calendar-days"></i> %s</time><span class="qedgrid__item__author"><i class="fa-solid fa-pencil"></i> %s</span></div></div>',
				$bg_image,

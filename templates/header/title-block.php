...
$fieldtitle  = get_field('show_title', get_the_ID());
$fieldtitle = ($fieldtitle)?$fieldtitle:get_field('show_title', get_option('page_for_posts'));
		...
		<div class="col-md-12">
			<div class="header-section padding-left padding-right">
				<div class="header-section__content<?php echo ( $breadcrumbs_html ? ' header-section__content--breadcrumbs' : ' header-section__content--title' ); ?>">
					<?php
					printf( '<div class="%s"><h1 class="header-section__title">%s</h1><div class="title__breadcrumbs">%s</div></div>',
